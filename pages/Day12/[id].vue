...
useSeoMeta({
    ...
    ogTitle: `${roomDetail.value.name}`,
    ogDescription: `${roomDetail.value.description}`,
    ogImage: `${roomDetail.value.imageUrl}`,
    ogUrl: `https://freyja.travel.com.tw/room/${hotelId}`,
    twitterCard: 'summary_large_image',
    twitterTitle: `Freyia | ${roomDetail.value.name}`,
...
<template>
    ...
    <div class="container">
        <button @click="router.push('/Day12')" class="btn btn-primary">回上一頁</button>
        <ClientOnly>
